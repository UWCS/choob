...
javac -classpath .:bsh-2.0b4.jar:c3p0-0.9.1.2.jar:en_phonet.dat:jazzy-core.jar:jcfd.jar:js-rhino-1.6r2.jar:mysql-connector-java-5.0.6-bin.jar:pircbot.jar uk/co/uwcs/choob/support/events/*.java uk/co/uwcs/choob/*.java uk/co/uwcs/choob/support/*.java uk/co/uwcs/choob/modules/*.java uk/co/uwcs/choob/plugins/*.java
