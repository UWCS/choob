...
/**
 * Module that currently only exists for shutup, but should be expandable for
 * any other controls that are needed over channels.
 * 
 * @author Faux
 */
public final class ProtectedChannels {
	List<String> channels = Collections
