...
/**
 * Module providing functionality allowing the BOT to extract information from a
 * website.
 */
public final class ScraperModule {
	private Map<java.net.URL, GetContentsCached> sites = Collections
			.synchronizedMap(new HashMap<URL, GetContentsCached>()); // URL
	...
	/**
	 * Get the contents, with caching, of the given URL, using the default
	 * timeout.
	 * 
	 * @param url
	 ...
	 *            The URL to get the contents of.
	 * @param timeout
	 *            The timeout to use when performing the operation.
	 * @throws java.io.IOException
	 * @return The contents of the URL provided.
	 */
	...
	/**
	 * Get the regular expression Matcher object for a specific URL and regular
	 * expression.
	 * 
	 * @param url
	 *            The URL to perform the regular expression on.
	 * @param timeout
	 *            The timeout to use when performing this operation.
	 * @param regex
	 *            The regular expression to use.
	 * @throws java.io.IOException
	 * @return The Matcher object requested.
	 */
	public Matcher getMatcher(URL url, long timeout, String regex)
			throws IOException {
	 ...
	 *            The URL to perform the regular expression on.
	 * @param regex
	 *            The Pattern object containing the regular expression to use.
	 * @throws java.io.IOException
	 * @return The Matcher object requested.
	 */
	 ...
	 * @return The Matcher object requested.
	 */
	public Matcher getMatcher(URL url, long timeout, Pattern regex)
			throws IOException {
	...
	public String convertEntities(final String html) {
		// Sorry, I just couldn't bring myself to do foreach (hashmap => key,
		// val) html=html.replaceall(key, val);
	 ...
	 * 
	 * @param html
	 *            The HTML String to perform the replacement on.
	 * @return The String suitably formatted to perform bold on IRC.
	 */
	public String boldTags(String html) {
		return html.replaceAll("(?i)<b>", Colors.BOLD).replaceAll("(?i)</b>",
				Colors.NORMAL);
	}

	public String quoteURLs(String html) {
		// return html.replaceAll("<a +?href *= *\"(.*?)\" *?>","[$1]
		// ").replaceAll("</a>","");
		return html;
		// This is going to require more than: return html.replaceAll("<a +?href
		// *= *\"(.*?)\" *?>",Colors.REVERSE + "<$1> " +
		// Colors.NORMAL).replaceAll("</a>","");
	}
	...
	/**
	 * Cleans a Sting of HTML of all tags in order to make it suitable for
	 * output in IRC.
	 * 
	 * @param html
	 *            The String containing HTML tags that is to be prepared for IRC
	 *            output.
