...
public final class ObjectDBObjectJSWrapper implements ObjectDBObject {
	...
	public ObjectDBObjectJSWrapper(Object obj) throws ChoobException,
		...
		if (!(obj instanceof Scriptable)) {
			throw new ChoobException(
					"Get out of here, that's not a JavaScript Scriptable object!");
		}
		this.obj = (Scriptable) obj;
		if (!ScriptRuntime.typeof(this.obj).equals("object")) {
			throw new ChoobException(
					"JavaScript object of the wrong type; only objects with typeof = 'object' allowed.");
		}
		...
		while (proto != null) {
			...
			for (int i = 0; i < props.length; i++) {
				if (props[i] instanceof String) {
					...
					System.err
							.println("WARNING: [ObjectDBObjectJSWrapper.getFields] Unexpected property type: "
	...
	public Type getFieldType(String name) throws NoSuchFieldException {
		...
		if (type.equals("undefined") || type.equals("object")
				|| type.equals("function") || type.equals("xml")) {
			return null;
		}
