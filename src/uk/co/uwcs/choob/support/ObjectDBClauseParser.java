/* Generated By:JJTree&JavaCC: Do not edit this line. ObjectDBClauseParser.java */
  ...
  protected JJTObjectDBClauseParserState jjtree = new JJTObjectDBClauseParserState();private int joins = 0;
                ...
                private boolean useMany = false; // XXX Only works with SELECT right now...
    ...
    while (true) {
      ...
      default:
        ...
        throw new ParseException();
                        ...
                        String realCols = (cols == null ? (useMany ? "s0.id" : "s0.ClassID") : parseExpression(cols, HINT_UNKNOWN));
                        String tableJoin = getTableJoin(); // Also updates joinWhere.
                        if (useMany)
                        {
                                {if (true) return "SELECT " + realCols + " FROM " + tableJoin + " WHERE " + where + " AND " + joinWhere + sort + limit;}
                        }
                        else
                        {
 ...
 */
  ...
  final public String ParseSort() throws ParseException {
    ...
    case FIELDNAME:
      ...
      t = jj_consume_token(FIELDNAME);
                                String suffix = useMany ? "" : isInt ? ".FieldBigInt" : ".FieldString";
