...
public class Shutup
{
	...
	public Shutup(final Modules mods, final IRCInterface irc)
	{
		this.mods = mods;
		this.irc = irc;
	}
	...
	public void interval(final Object strChannel)
	{
		final String channel = (String)strChannel;
	...
	public void onMessage(final ChannelMessage mes)
	{
		...
		final LastMessage la = lastMessage.get(channel);
		...
		{
			la.save();
			final long totalEventDelay = la.difference();
